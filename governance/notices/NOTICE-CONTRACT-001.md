...
artifact_version: v0.1.22
status: IN_REVIEW
owner: LaoYu-Professional-Screenwriter
upstream_ids: [CONTRACT-PROFESSIONAL-SCREENWRITER]
review_id: REVIEW-CONTRACT-001
review_decision: PENDING
evidence_refs: [PLAN-v1.0.8, PHASE-1-COMPLETE, PHASE-2-COMPLETE, A1-VE-MAPPING, WP3B-PLACEHOLDERS, WP3B-ENUMS, WP3B-PLACEHOLDER-REPAIR, WP3B-UPSTREAM, WP4A-OWNERSHIP-AUDIT, WP3A-FEATURE-SCENES, A2-HANDOFF-STRUCTURE, A3B-SKILL-DEDUP, A4-EVIDENCE-CHAIN, A5-LICENSE-BOUNDARY, WP5-SINGLE-SOURCES, WP1B-STRICT-HYGIENE, A6-IDENTIFIER-BOUNDARIES, WP4B-FULL-VALIDATION, BENCH-PSW-v1.0.0-20260801, BENCH-PSW-E7-T2-R1-20260809, BENCH-PSW-E7-T2-R2-20260809, E7-CONTENT-ROLLBACK-20260812, BENCH-PSW-v1.0.0-20260812-ROLLBACK, E7-T4-RIGHTS-ROUTE-20260812, BENCH-PSW-v1.0.0-20260812-RIGHTS-ROUTE, USER-QUALITY-EXCEPTION-20260813-001, USER-TOKEN-EXCEPTION-20260814-001]
...
verification_refs: [WP4B-FULL-VALIDATION, ROOT-CANDIDATE-VALIDATION, PHASE4-QUALITY-GATE-FAIL, E7-T2-R1-FAIL, E7-T2-R2-FAIL, E7-CONTENT-ROLLBACK-CONTROL-GATE, PHASE4-ROLLBACK-RETEST-FAIL, E7-T4-RIGHTS-ROUTE-UNIT, E7-T4-RIGHTS-ROUTE-FULL-RETEST-FAIL]
...
- `MIG-E7-T4-RIGHTS-ROUTE`：`ROUTE_VERIFIED / FULL_RETEST_FAILED / HOLD`。新候选
  `cd14ba43aefd272f8b63399cc0d68a6178c391a6` 已从零完成 T1–T4 双臂固定 `n=3` 全量复测；
...
- `EX-TOKEN-001`：`ACCEPTED_RISK / TOKEN_EXCEPTION_ACCEPTED`。余老师于 2026-08-14 独立接受
  T1 `+7,326（+1.2%）`、T4 `+12,163（+3.8%）` 的任务级成本风险；E.5 正式 FAIL 保留，
  不以 T2/T3 节省抵消，不宣称已经证明为测量噪声；
- Notice 的控制迁移状态保持 `VERIFIED`；质量与 Token 例外均已记录，允许按 D-SIGN 进入
  §11.1 prepare-only staging，但当前仍未获得拟激活 digest 的最终确认。旧 `f8a1626`、R1、R2、
...
old_version: v0.2.6
new_version: v0.2.7
old_digest: sha256:098842456369b70d4e1b8eae2fbaa5ad41160b840aa0406c171a1a7e64371973
new_digest: sha256:45960151bf8073d9922740ceedcf3a6e6048d2ee4cd527699c6f351b319f873c
disposition: CONTENT_CHANGED
reason: 将只绑定当前候选的 Token 例外、E.5 正式 FAIL 保留、下一轮方差/容差阻断债及 prepare-only 状态写入 v0.2.7；active baseline 保持不变。
```
