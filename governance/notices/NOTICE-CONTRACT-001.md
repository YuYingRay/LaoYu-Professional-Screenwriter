...
verification_refs: [WP4B-FULL-VALIDATION, ROOT-CANDIDATE-VALIDATION, PHASE4-QUALITY-GATE-FAIL, E7-T2-R1-FAIL, E7-T2-R2-FAIL]
...
- `MIG-PHASE4-E7-T2`：`VERIFIED`。只对 T2 实际加载的改动文件执行两轮定向修复；R1 的
  D1/D4 与 R2 的 D1/D4 均未通过 `E.4.1-C`。已按 E.7 第 5 级停止，等待用户裁决，
  未进行第三轮、质量例外、Token 例外或激活；
...
new_digest: sha256:67a8a3fd2b2c3bc91a4c66c235c3ed4236864951f85aace3b717f915a3f4f222
disposition: CONTENT_CHANGED
reason: 将既有候选迁移、Phase 4 门禁 FAIL 与 E.7 两轮 T2 定向修复 FAIL 纳入 v0.2.1 影响闭包；active baseline 保持不变。
```
