...
LIST_LINE_RE = re.compile(
    r"^(upstream_ids|evidence_refs|verification_refs|affected_ids|affected_paths|coupling|migration_tasks|changed_schema_sections|change_records|findings|continuity_claims):\s*(\[.*\])\s*$"
)
