...
|---|---|
| 项目名 | 未登记的妹妹 |
| 项目 ID | PROJECT-VERTICAL-001 |
| 项目基线 | PROJECT-VERTICAL-v1.0.0 |
| 格式 | 36 集竖屏微短剧，每集 90 秒 |
| 受众 | 喜欢身份悬疑、亲情和连续追更的移动端观众 |
| 画幅 | 9:16 |
| 商业模式 | 逐集解锁；付费点必须有前置投入与快速回报 |
| 当前阶段 | DEVELOPMENT |
